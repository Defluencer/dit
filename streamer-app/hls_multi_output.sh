...
ffmpeg -listen 1 -i rtmp://127.0.0.1:2525 -rtmp_live live -rtmp_buffer 8000 \
...
-hls_segment_type fmp4 -hls_segment_filename http://127.0.0.1:2526/%%v/%%d.fmp4 \
-http_persistent 1 -ignore_io_errors 1 \
-method PUT http://127.0.0.1:2526/%%v/index.m3u8