...
- Allow CORS with these commands;
    ...
    - ipfs config --json API.HTTPHeaders.Access-Control-Allow-Origin '["http://localhost:5001", "http://127.0.0.1:5001", "http://defluencer.eth"]'
...
- Input defluencer.eth/ in your browser